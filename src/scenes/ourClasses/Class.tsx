...
const Class = ({ name, description, image }: Props) => {
  ...
  text-center text-white opacity-0 transition duration-500 hover:opacity-90 rounded-md`;
  return (
    <li className="relative mx-5 inline-block h-[380px] w-[450px] rounded-r-md">
